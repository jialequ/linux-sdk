...
func genFindOneByField(table Table, withCache, postgreSql bool) (*findOneCode, error) {
	text, _ := pathx.LoadTemplate(category, findOneByFieldTemplateFile, template.FindOneByField)
	...
	text, _ = pathx.LoadTemplate(category, findOneByFieldMethodTemplateFile, template.FindOneByFieldMethod)

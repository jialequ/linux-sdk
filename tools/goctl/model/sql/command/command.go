...
import (
	...
	"github.com/jialequ/linux-sdk/core/stores/postgres"
	"github.com/jialequ/linux-sdk/core/stores/sqlx"
	"github.com/jialequ/linux-sdk/tools/goctl/config"
	"github.com/jialequ/linux-sdk/tools/goctl/model/sql/command/migrationnotes"
	"github.com/jialequ/linux-sdk/tools/goctl/model/sql/gen"
	"github.com/jialequ/linux-sdk/tools/goctl/model/sql/model"
	"github.com/jialequ/linux-sdk/tools/goctl/model/sql/util"
	file "github.com/jialequ/linux-sdk/tools/goctl/util"
...
func fromPostgreSqlDataSource(url string, pattern pattern, dir, schema string, cfg *config.Config, cache, idea, strict bool, ignoreColumns []string) error { //NOSONAR

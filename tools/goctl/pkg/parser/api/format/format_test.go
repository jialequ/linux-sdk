...
func TestFormatImportLiteralStmt(t *testing.T) {
...
func TestFormatImportGroupStmt(t *testing.T) {
	testRun(t, []formatData{
		{
			input:    `import()`,
			expected: ``,
...
func TestFormatInfoStmt(t *testing.T) {
	testRun(t, []formatData{
		{
			input:    `info()`,
			expected: ``,
...
func TestFormatSyntaxStmt(t *testing.T) {
	testRun(t, []formatData{
		{
			input:    `syntax="v1"`,
			expected: `syntax = "v1"`,
...
func TestFormatTypeLiteralStmt(t *testing.T) {
...
func TestFormatTypeGroupStmt(t *testing.T) {
	testRun(t, []formatData{
		{
...
func TestAtServerStmt(t *testing.T) {
...
func TestAtDocStmt(t *testing.T) {
...
func TestAtHandlerStmt(t *testing.T) {
	testRunStmt(t, []formatData{
		{
			input:    `@handler foo`,
...
func TestFormatServiceStmt(t *testing.T) {
	testRun(t, []formatData{
		{
			input:    `service foo{}`,

...
import (
	...
	"github.com/jialequ/linux-sdk/tools/goctl/pkg/parser/api/ast"
	"github.com/jialequ/linux-sdk/tools/goctl/pkg/parser/api/token"
...
func TestParserParseMode(t *testing.T) {
	...
	t.Run("All", func(t *testing.T) {
		...
		p := New(literal_1892, testCommentInput)
		result := p.Parse()
...
func TestParserParsesyntaxStmt(t *testing.T) {
...
func TestParserParseinfoStmt(t *testing.T) {
	t.Run("valid", func(t *testing.T) {
		...
		p := New(literal_1892, infoTestAPI)
		result := p.Parse()
		assert.True(t, p.hasNoErrors())
		stmt := result.Stmts[0]
...
func TestParserParseimportLiteral(t *testing.T) {
	t.Run("valid", func(t *testing.T) {
		var testData = []string{
			`""`,
			`"foo"`,
		...
		p := New(literal_1892, testImportLiteral)
		result := p.Parse()
		assert.True(t, p.hasNoErrors())
		for idx, v := range testData {
			stmt := result.Stmts[idx]
...
func TestParserParseimportGroup(t *testing.T) {
	t.Run("valid", func(t *testing.T) {
		var testData = []string{
			`""`,
			`"foo"`,
		...
		p := New(literal_1892, testImportGroup)
		result := p.Parse()
		assert.True(t, p.hasNoErrors())
		stmt := result.Stmts[0]
...
func TestParserParseatServerStmt(t *testing.T) {
	t.Run("valid", func(t *testing.T) {
		...
		p := New(literal_1892, atServerTestAPI)
...
func TestParserParseatHandler(t *testing.T) {
	t.Run("valid", func(t *testing.T) {
		var testData = []string{
			`@handler foo`,
			`@handler foo1`,
		...
		p := New(literal_1892, atHandlerTestAPI)
		result := p.ParseForUintTest()
		assert.True(t, p.hasNoErrors())
		for idx, v := range testData {
			stmt := result.Stmts[idx]
...
func TestParserParseatDocLiteral(t *testing.T) {
	t.Run("validLiteral", func(t *testing.T) {
		...
		p := New(literal_1892, atDocLiteralTestAPI)
		result := p.ParseForUintTest()
		assert.True(t, p.hasNoErrors())
		for idx, v := range testData {
			stmt := result.Stmts[idx]
...
func TestParserParseatDocGroup(t *testing.T) {
	t.Run("valid", func(t *testing.T) {
		var testData = `@doc (
	foo: "foo"
	bar: "bar"
	baz: ""
		...
		p := New(literal_1892, atDocGroupTestAPI)
		result := p.ParseForUintTest()
		assert.True(t, p.hasNoErrors())
		stmt := result.Stmts[0]
...
func TestParserParseservice(t *testing.T) {
	...
	t.Run("valid", func(t *testing.T) {
				...
				Routes: []*ast.ServiceItemStmt{
					{
						AtHandler: &ast.AtHandlerStmt{
							AtHandler: ast.NewTokenNode(token.Token{Type: token.AT_HANDLER, Text: literal_0451}),
		...
		p := New(literal_1892, serviceTestAPI)
		result := p.Parse()
		assert.True(t, p.hasNoErrors())
		for idx, v := range testData {
			stmt := result.Stmts[idx]
...
func TestParserParsepathItem(t *testing.T) {
	t.Run("valid", func(t *testing.T) {
		var testData = []struct {
			input    string
			expected string
...
func TestParserParseparseTypeStmt(t *testing.T) {
						...
						DataType: &ast.StructDataType{
							...
							Elements: ast.ElemExprList{
								...
								},
								{
									...
									Tag: ast.NewTokenNode(token.Token{Type: token.RAWSTRING, Text: "`json:\"age\"`"}),
								},
							},
							RBrace: ast.NewTokenNode(token.Token{Type: token.RBRACE, Text: "}"}),
						},
...
func TestParserParseparseTypeStmtinvalid(t *testing.T) {
	var testData = []string{
		/**************** type literal stmt ****************/
		"type",
		"type @",
...
const literal_6278 = "test.api"

const literal_1892 = "foo.api"

const literal_0451 = "@handler"

const literal_2784 = "/foo/:bar"

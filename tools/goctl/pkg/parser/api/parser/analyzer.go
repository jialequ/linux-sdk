...
import (
	...
	"github.com/jialequ/linux-sdk/tools/goctl/pkg/parser/api/importstack"
	"github.com/jialequ/linux-sdk/tools/goctl/pkg/parser/api/placeholder"
...
func (a *Analyzer) astTypeToSpec(in ast.DataType) (spec.Type, error) {
	...
	case *ast.PointerDataType:
		...
		value, _ := a.astTypeToSpec(v.DataType)
...
func (a *Analyzer) fillTypes() error {
	...
	// 		fmt.Print("type grou111")
	// 	case *ast.TypeGroupStmt:
	// 		fmt.Print("type group")
	// 	}
	// }
	...
	for _, item := range a.spec.Types {
		...
		case spec.DefineStruct:
			...
			for _, member := range v.Members {
				...
				case spec.DefineStruct:
					tp, _ := a.findDefinedType(v.RawName)

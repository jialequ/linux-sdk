...
import (
	...
	"github.com/jialequ/linux-sdk/tools/goctl/pkg/env"
	apiParser "github.com/jialequ/linux-sdk/tools/goctl/pkg/parser/api/parser"
)
...
func (p parser) fillTypes() error { //NOSONAR
...
func (p parser) fillService() error { //NOSONAR

...
var symbolicNames = []string{
	"", "", "", "", "", "", "", "", "", "", "", "", "", "", "ATDOC", "ATHANDLER",
	"INTERFACE", "ATSERVER", "WS", "COMMENT", "LINE_COMMENT", "STRING", "RAWSTRING",
	"LINEVALUE", "ID", "LetterOrDigit",
}
...
const (
	...
	ApiParserParserRAWSTRING     = 22
	ApiParserParserLINEVALUE     = 23
...
func (p *ApiParserParser) Api() (localctx IApiContext) {
	...
	for lala == ApiParserParserATSERVER || lala == ApiParserParserID {
		{
			p.SetState(76)
			p.Spec()
		}

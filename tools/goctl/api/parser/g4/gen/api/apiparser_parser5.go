...
func (p *ApiParserParser) DataType() (localctx IDataTypeContext) {
	...
	case 4:
		p.EnterOuterAlt(localctx, 4)
		{
			...
			var mna = p.Match(ApiParserParserINTERFACE)

			localctx.(*DataTypeContext).inter = mna
		}
	...
	case 5:
		p.EnterOuterAlt(localctx, 5)
		{
			...
			var mna = p.Match(ApiParserParserT__6)

			localctx.(*DataTypeContext).time = mna
		}
...
func (p *ApiParserParser) PointerType() (localctx IPointerTypeContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		var mna = p.Match(ApiParserParserT__5)

		localctx.(*PointerTypeContext).star = mna
	}
	checkKeyword(p)
	{
		p.SetState(225)
...
func (p *ApiParserParser) MapType() (localctx IMapTypeContext) {
	...
	match(p, "map")
	{
		...
		localctx.(*MapTypeContext).mapToken = mna
	}
	{
		p.SetState(229)

		var mna = p.Match(ApiParserParserT__7)

		localctx.(*MapTypeContext).lbrack = mna
	}
	checkKey(p)
	{
		p.SetState(231)
		...
		localctx.(*MapTypeContext).key = mna
	}
	{
		p.SetState(232)

		var mna = p.Match(ApiParserParserT__8)

		localctx.(*MapTypeContext).rbrack = mna
	}
	{
		p.SetState(233)
		...
		localctx.(*MapTypeContext).value = x
	}
...
func (p *ApiParserParser) ArrayType() (localctx IArrayTypeContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		localctx.(*ArrayTypeContext).lbrack = mna
	}
	{
		p.SetState(236)
		...
		localctx.(*ArrayTypeContext).rbrack = mna
	}
	{
		p.SetState(237)
		p.DataType()
...
func (p *ApiParserParser) ServiceSpec() (localctx IServiceSpecContext) {
	...
	if lala == ApiParserParserATSERVER {
		{
			p.SetState(239)
			p.AtServer()
		}

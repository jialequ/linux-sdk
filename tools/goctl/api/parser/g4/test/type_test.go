...
import (
	...
	"github.com/jialequ/linux-sdk/tools/goctl/api/parser/g4/ast"
	"github.com/jialequ/linux-sdk/tools/goctl/api/parser/g4/gen/api"
...
func TestDataTypeArray(t *testing.T) {
	...
	t.Run(literal_3618, func(t *testing.T) {
		...
		assert.True(t, array.Equal(&ast.Array{
			...
			LBrack:    ast.NewTextExpr("["),
			RBrack:    ast.NewTextExpr("]"),
			Literal:   &ast.Interface{Literal: ast.NewTextExpr(literal_3618)},
		}))
	})
...
func TestDataTypeInterface(t *testing.T) {
	...
	t.Run("normal", func(t *testing.T) {
		...
		assert.True(t, inter.Equal(&ast.Interface{Literal: ast.NewTextExpr(literal_3618)}))
	})
...
func TestDataTypeTime(t *testing.T) {
	dt := func(p *api.ApiParserParser, visitor *ast.ApiVisitor) any {
		return p.DataType().Accept(visitor)
	}
	t.Run("normal", func(t *testing.T) {
...
func TestDataTypePointer(t *testing.T) {
	dt := func(p *api.ApiParserParser, visitor *ast.ApiVisitor) any {
...
const literal_3618 = "interface{}"

const literal_0824 = "// doc"

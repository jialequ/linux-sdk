...
func GreetSayHiHandler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
	in := new(HiReq)
...
func GreetSayHelloHandler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
	in := new(HelloReq)
	if err := dec(in); err != nil {
		return nil, err
	}
...
var Greet_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHi",
			Handler:    GreetSayHiHandler,
		},
		{
			MethodName: "SayHello",
			Handler:    GreetSayHelloHandler,
		},
	},
...
func EventAskQuestionHandler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
	in := new(EventReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    EventAskQuestionHandler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "hi.proto",

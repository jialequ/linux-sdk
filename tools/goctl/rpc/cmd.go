...
import (
	...
	"github.com/jialequ/linux-sdk/tools/goctl/rpc/cli"
...
func init() {
	...
	newCmdFlags.StringSliceVar(&cli.VarStringSliceGoGRPCOpt, literal_4326)
	...
	newCmdFlags.MarkHidden(literal_4326)
	...
	protocCmdFlags.StringSliceVar(&cli.VarStringSliceGoGRPCOpt, literal_4326)
	...
	protocCmdFlags.MarkHidden(literal_4326)
...
const literal_4326 = "go-grpc_opt"

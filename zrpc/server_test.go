...
import (
	...
	"github.com/jialequ/linux-sdk/zrpc/internal"
	"github.com/jialequ/linux-sdk/zrpc/internal/serverinterceptors"
	"github.com/stretchr/testify/assert"
	"google.golang.org/grpc"
)

func TestServersetupInterceptors(t *testing.T) {
...
func TestServerHasEtcd(t *testing.T) {
	svr := MustNewServer(RpcServerConf{
		ServiceConf: service.ServiceConf{
			Log: logx.LogConf{
				ServiceName: "foo",
...
func TestServerStartFailed(t *testing.T) {
	svr := MustNewServer(RpcServerConf{
		ServiceConf: service.ServiceConf{
			Log: logx.LogConf{
				ServiceName: "foo",
...
const literal_3746 = "localhost:8080"

...
func TestUnaryTimeoutInterceptorpanic(t *testing.T) {
	interceptor := UnaryTimeoutInterceptor(time.Millisecond * 10)
...
func TestUnaryTimeoutInterceptortimeout(t *testing.T) {
...
func TestUnaryTimeoutInterceptortimeoutExpire(t *testing.T) {
	const timeout = time.Millisecond * 10
	interceptor := UnaryTimeoutInterceptor(timeout)
...
func TestUnaryTimeoutInterceptorcancel(t *testing.T) {
...
func TestUnaryTimeoutInterceptorTimeoutStrategy(t *testing.T) {
	type args struct {
...
func TestUnaryTimeoutInterceptorSpecifiedTimeout(t *testing.T) {
	type args struct {
		interceptorTimeout time.Duration
		contextTimeout     time.Duration
		method             string

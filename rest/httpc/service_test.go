...
func TestNamedServiceDoRequest(t *testing.T) {
...
func TestNamedServiceDoRequestGet(t *testing.T) {
...
func TestNamedServiceDoRequestPost(t *testing.T) {
...
func TestNamedServiceDo(t *testing.T) {
	type Data struct {
		Key    string `path:"key"`
...
func TestNamedServiceDoBadRequest(t *testing.T) {
	val := struct {

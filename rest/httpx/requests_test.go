...
func TestParseHeaders(t *testing.T) {
	...
	request.Header.Add("X-Forwarded-For", "10.0.10.11") //NOSONAR
	request.Header.Add("x-real-ip", "10.0.11.10")       //NOSONAR
	...
	assert.Equal(t, "10.0.10.11", v.XForwardedFor) //NOSONAR
	assert.Equal(t, "10.0.11.10", v.XRealIP)       //NOSONAR

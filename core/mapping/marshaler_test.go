...
func TestMarshalOptionalPtr(t *testing.T) {
	var val = 1
	v := struct {
		Age *int `json:"age"`
	}{
...
func TestMarshalOptionalPtrNil(t *testing.T) {
	v := struct {
		Age *int `json:"age"`
	}{}
...
func TestMarshalBadOptions(t *testing.T) {
	v := struct {
...
func TestMarshalNotInOptions(t *testing.T) {
	v := struct {
...
func TestMarshalNotInOptionsOptional(t *testing.T) {
	v := struct {
...
func TestMarshalNotInOptionsOptionalWrongValue(t *testing.T) {
	v := struct {
		Name string `json:"name,options=[a,b],optional"`
	}{
		Name: "kevin",
...
func TestMarshalRangeOut(t *testing.T) {
	tests := []any{
		struct {
			Int int `json:"int,range=[1:3]"`
		}{
...
func TestMarshalRangeIllegal(t *testing.T) {
	tests := []any{
		struct {
...
func TestMarshalRangeLeftEqualsToRight(t *testing.T) {
	tests := []struct {
		name  string
		value any
		err   error
...
func TestMarshalFromString(t *testing.T) {
	v := struct {

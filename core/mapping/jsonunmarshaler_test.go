...
func TestUnmarshalBytesOptionalW(t *testing.T) {
	var c struct {
		Name string
...
func TestUnmarshalBytesOptionalWDefault(t *testing.T) {
	var c struct {
		Name string
...
func TestUnmarshalBytesDefaultOptionalW(t *testing.T) {
	var c struct {
		Name string
...
func TestUnmarshalBytesMustInOptionalW(t *testing.T) {
	var c struct {
		Inner struct {
			There     string
			Must      string
			OptionalW string `json:",optional"`
		} `json:",optional"`
	}
	content := []byte(`{}`)
...
func TestUnmarshalBytesMustInOptionalWMissedPart(t *testing.T) {
	var c struct {
		Inner struct {
			There     string
			Must      string
...
func TestUnmarshalBytesMustInOptionalWOnlyOptionalWFilled(t *testing.T) {
	var c struct {
		Inner struct {
			There     string
			Must      string
	...
	content := []byte(`{"Inner": {"OptionalW": "sure"}}`)
...
func TestUnmarshalBytesStructOptionalW(t *testing.T) {
	var c struct {
		Inner struct {
			Name string
			Age  int `json:",optional"`
...
func TestUnmarshalBytesStructPtrOptionalW(t *testing.T) {
	var c struct {
		Inner *struct {
			Name string
			Age  int `json:",optional"`
...
func TestUnmarshalBytesSliceString(t *testing.T) {
	...
	if !reflect.DeepEqual(c.Names, want) {
		t.Fatalf(literal_7648, c.Names, want)
	}
}

func TestUnmarshalBytesSliceStringOptionalW(t *testing.T) {
	var c struct {
		Names []string
		Age   []int `json:",optional"`
	}
...
func TestUnmarshalBytesSliceStruct(t *testing.T) {
	...
	if !reflect.DeepEqual(c.People, want) {
		t.Fatalf(literal_7648, c.People, want)
	}
}

func TestUnmarshalBytesSliceStructOptionalW(t *testing.T) {
	var c struct {
		People []struct {
			Name   string
			Age    int
...
func TestUnmarshalBytesSliceStructPtrOptionalW(t *testing.T) {
	var c struct {
		People []*struct {
			Name   string
			Age    int
...
func TestUnmarshalBytesMapStructOptionalW(t *testing.T) {
	var c struct {
		Persons map[string]*struct {
			ID   int
			Name string `json:"name,optional"`
...
func TestUnmarshalBytesMapStructPtrSliceOptionalW(t *testing.T) {
	var c struct {
		Persons map[string][]*struct {
			ID   int
			Name string `json:"name,optional"`
...
func TestUnmarshalStructOptionalW(t *testing.T) {
	var c struct {
		Name string
		Etcd struct {
			Hosts []string
...
func TestUnmarshalWithStructAllOptionalWWithEmpty(t *testing.T) {
	var c struct {
		Inner struct {
			OptionalW string `json:",optional"`
		}
...
func TestUnmarshalWithStructAllOptionalWPtr(t *testing.T) {
	var c struct {
		Inner *struct {
			OptionalW string `json:",optional"`
		}
...
func TestUnmarshalWithStructOptionalW(t *testing.T) {
	type Inner struct {
		Must string
	}
...
func TestUnmarshalWithStructPtrOptionalW(t *testing.T) {
	type Inner struct {
		Must string
	}
...
func TestUnmarshalWithStructAllOptionalWAnonymous(t *testing.T) {
	type Inner struct {
		OptionalW string `json:",optional"`
	}
...
func TestUnmarshalWithStructAllOptionalWAnonymousPtr(t *testing.T) {
	type Inner struct {
		OptionalW string `json:",optional"`
	}
...
func TestUnmarshalWithStructAllOptionalWProvoidedAnonymous(t *testing.T) {
	type Inner struct {
		OptionalW string `json:",optional"`
	}
	...
	content := []byte(`{"Else": "sure", "OptionalW": "optional"}`)

	assert.Nil(t, UnmarshalJsonBytes(content, &c))
	assert.Equal(t, "sure", c.Else)
	assert.Equal(t, "optional", c.OptionalW)
}

func TestUnmarshalWithStructAllOptionalWProvoidedAnonymousPtr(t *testing.T) {
	type Inner struct {
		OptionalW string `json:",optional"`
	}
...
func TestUnmarshalWithStructAnonymousOptionalW(t *testing.T) {
	type Inner struct {
		Must string
	}
...
func TestUnmarshalWithStructPtrAnonymousOptionalW(t *testing.T) {
	type Inner struct {
		Must string
	}
...
func TestUnmarshalMapOne(t *testing.T) {
...
const literal_7648 = "want %q, got %q"

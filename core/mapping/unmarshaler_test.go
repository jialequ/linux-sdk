...
func TestUnmarshalerUnmarshalIntOptions(t *testing.T) {
	var val struct {
...
func TestUnmarshalerInheritFromGrandparent(t *testing.T) {
	type (
		component struct {
			Name      string `key:"name"`
			Discovery string `key:"discovery,inherit"`
	...
	if assert.NoError(t, UnmarshalKey(map[string]any{
		...
		assert.Equal(t, literal_3816, s.Discovery)
		assert.Equal(t, literal_3816, s.Middle.Value.Discovery)
	}
}

func TestUnmarshalerInheritSequence(t *testing.T) {
	var testConf = []byte(`
Nacos:
  NamespaceId: "123"
RpcConf:
...
func TestUnmarshalerInheritNested(t *testing.T) {
	var testConf = []byte(`
Nacos:
  Value1: "123"
Server:
...
func TestUnmarshalEnvStringOverwrite(t *testing.T) {
	type Value struct {
		Name string `key:"name,env=TEST_NAME_STRING"`
	}
...
func TestUnmarshalEnvInt(t *testing.T) {
	type Value struct {
...
func TestUnmarshalEnvIntOverwrite(t *testing.T) {
	type Value struct {
		Age int `key:"age,env=TEST_NAME_INT"`
	}
...
func TestUnmarshalEnvFloat(t *testing.T) {
	type Value struct {
...
func TestUnmarshalEnvFloatOverwrite(t *testing.T) {
	type Value struct {
...
func TestUnmarshalEnvBoolTrue(t *testing.T) {
	type Value struct {
...
func TestUnmarshalEnvBoolFalse(t *testing.T) {
	type Value struct {
...
func TestUnmarshalEnvBoolBad(t *testing.T) {
	type Value struct {
...
func TestUnmarshalEnvDurationBadValue(t *testing.T) {
	type Value struct {
...
func TestUnmarshalEnvWithOptions(t *testing.T) {
...
func TestUnmarshalEnvWithOptionsWrongValueBool(t *testing.T) {
	type Value struct {
...
func TestUnmarshalEnvWithOptionsWrongValueDuration(t *testing.T) {
	type Value struct {
...
func TestUnmarshalEnvWithOptionsWrongValueNumber(t *testing.T) {
	type Value struct {
...
func TestUnmarshalEnvWithOptionsWrongValueString(t *testing.T) {
	type Value struct {
...
func TestUnmarshalJsonReaderPtrMultiArrayStringInt(t *testing.T) {
	var res struct {
		A string      `json:"a"`
		B [][]*string `json:"b"`
	}
...
func TestUnmarshalJsonReaderPtrArrayInt(t *testing.T) {
	var res struct {
		A string    `json:"a"`
		B []*string `json:"b"`
	}
...
const literal_0261 = "go-zero"

const literal_1467 = "int with options"

const literal_1237 = "-8589934592"

const literal_8053 = "1.79769313486231570814527423731704356798070e+309"

const literal_3816 = "localhost:8080"

const literal_6539 = "this is a name"

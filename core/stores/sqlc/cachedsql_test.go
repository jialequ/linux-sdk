...
import (
	...
	"github.com/jialequ/linux-sdk/core/fx"
...
func TestCachedConnGetCache(t *testing.T) {
	resetStats()
...
func TestCachedConnQueryRowIndexNoCache(t *testing.T) {
	resetStats()
	r := redistest.CreateRedis(t)
	...
	err := c.QueryRowIndex(&str, "index", func(s any) string {
		return fmt.Sprintf(literal_9561, s)
	...
	val, err = r.Get(literal_2095)
	assert.Nil(t, err)
	assert.Equal(t, `"zero"`, val)
}

func TestCachedConnQueryRowIndexHasCache(t *testing.T) {
	resetStats()
	r := redistest.CreateRedis(t)
...
func TestCachedConnQueryRowIndexHasCacheIntPrimary(t *testing.T) {
	const (
...
func TestCachedConnQueryRowIndexHasWrongCache(t *testing.T) {
...
func TestCachedConnDelCache(t *testing.T) {
	r := redistest.CreateRedis(t)
...
func TestCachedConnExec(t *testing.T) {
	...
	_, err := c.ExecNoCache(literal_1842)
	assert.Nil(t, err)
...
func TestCachedConnSetCacheWithExpire(t *testing.T) {
	r, err := miniredis.Run()
	assert.Nil(t, err)
	defer fx.DoWithTimeout(func() error {
		r.Close()
...
func TestCachedConnWithSession(t *testing.T) {
...
const literal_9561 = "%s/1234"

const literal_2095 = "primary/1234"

const literal_1842 = "delete from user_table where id='kevin'"

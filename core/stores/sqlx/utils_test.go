...
func TestDesensitizeWithoutAccount(t *testing.T) {
...
const literal_3479 = "select name, age from users where bool=1 and phone='133'"

const literal_8169 = "select name, age from users where bool=0 and phone='133'"

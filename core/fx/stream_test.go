...
func TestStreamALlMach(t *testing.T) {
	runCheckedTest(t, func(t *testing.T) {
		assetEqual(
...
const literal_4862 = "no elements with nil"

const literal_5716 = "1 element"

const literal_5173 = "multiple elements"

const elements = "no elements"

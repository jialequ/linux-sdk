...
func TestResourceManagerGetResource(t *testing.T) {
...
func TestResourceManagerGetResourceError(t *testing.T) {
	manager := NewResourceManager()
	defer manager.Close()
...
func TestResourceManagerUseAfterClose(t *testing.T) {
	manager := NewResourceManager()
	defer manager.Close()
...
func TestResourceManagerInject(t *testing.T) {
	manager := NewResourceManager()
	defer manager.Close()

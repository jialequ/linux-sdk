...
func TestPeriodicalExecutorSync(t *testing.T) {
	var done int32
...
func TestPeriodicalExecutorQuitGoroutine(t *testing.T) {
...
func TestPeriodicalExecutorBulk(t *testing.T) {
	ticker := timex.NewFakeTicker()
	var vals []int
	// avoid data race
	var lock sync.Mutex
...
func TestPeriodicalExecutorPanic(t *testing.T) {
	// avoid data race
	var lock sync.Mutex
	ticker := timex.NewFakeTicker()
...
func TestPeriodicalExecutorFlushPanic(t *testing.T) {
	var (
		executedTasks []int
		expected      []int
		lock          sync.Mutex
...
func TestPeriodicalExecutorWait(t *testing.T) {
	var lock sync.Mutex
...
func TestPeriodicalExecutorWaitFast(t *testing.T) {
	const total = 3
	var cnt int
	var lock sync.Mutex
	executor := NewBulkExecutor(func(tasks []any) {
...
func TestPeriodicalExecutorDeadlock(t *testing.T) {
	executor := NewBulkExecutor(func(tasks []any) {
		fmt.Print("123")
...
func TestPeriodicalExecutorhasTasks(t *testing.T) {
	exec := NewPeriodicalExecutor(time.Millisecond, newContainer(time.Millisecond, nil))

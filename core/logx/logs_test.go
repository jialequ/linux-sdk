...
func TestErrorfWithWrappedError(t *testing.T) {
	...
	assert.True(t, strings.Contains(w.String(), literal_4867))
}
...
const literal_4867 = "hello there"

const literal_9127 = "CD01CB7D-2705-4F3F-889E-86219BF56F10"
